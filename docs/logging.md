...
- Default path: `$OPENCLAW_STATE_DIR/logs/anthropic-payload.jsonl`
- Env enable: `OPENCLAW_ANTHROPIC_PAYLOAD_LOG=1`
- Env path: `OPENCLAW_ANTHROPIC_PAYLOAD_LOG_FILE=/path/to/anthropic-payload.jsonl`
